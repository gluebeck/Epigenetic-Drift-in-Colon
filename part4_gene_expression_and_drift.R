...
write.csv(gexmex.left,file='./GitHub/gexmex.left.drift.csv')
...
write.csv(gexmex.right,file='./GitHub/gexmex.right.drift.csv')
...
gexmex.Right = data.frame(gene = genes[io],r=corr[-iex][io],
                          pval=pval[-iex][io],qval=tmp$qvalues[io])
gexmex.Right = gexmex.Right[cond[io],] # top ranked by q-values < 0.01
write.csv(gexmex.Right,file='./GitHub/gexmex.right.static.csv')
...
## plot some data
cond = grepl("chr19:58038572-58039208",rlab)
